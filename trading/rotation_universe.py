...
# Curated universe (41 symbols): manually selected USDC set with
# structurally weak listing profiles removed.
POOL: tuple[str, ...] = (
    "BTC",
    "ETH",
    "BNB",
...
LEGACY_PORTS: dict[str, tuple[int, int, int, int, int]] = {
    ...
    "ZRO": (8206, 13310, 13320, 13330, 13340),
    "BTC": (8208, 13410, 13420, 13430, 13440),
    "CAKE": (8210, 13510, 13520, 13530, 13540),
    "ZEN": (8212, 13610, 13620, 13630, 13640),
    "QNT": (8214, 13710, 13720, 13730, 13740),
    "POL": (8216, 13810, 13820, 13830, 13840),
    "GMX": (8218, 13910, 13920, 13930, 13940),
    "PENDLE": (8226, 14310, 14320, 14330, 14340),
    "SIGN": (8232, 14610, 14620, 14630, 14640),
    "WLFI": (8234, 14710, 14720, 14730, 14740),
}
