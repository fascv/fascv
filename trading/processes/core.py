            ...
            if cmd.action == "PAUSE":
                ...
                risk_manager = RiskManager(
                    RiskConfig(
                        ...
                        profit_roll_exit_enabled=getattr(rcfg, "profit_roll_exit_enabled", False),
                        profit_roll_arm_eur=getattr(rcfg, "profit_roll_arm_eur", 0.0),
                        profit_roll_retrace_eur=getattr(rcfg, "profit_roll_retrace_eur", 0.0),
                        profit_roll_retrace_pct=getattr(rcfg, "profit_roll_retrace_pct", 50.0),
                        profit_roll_min_retrace_eur=getattr(
                            rcfg, "profit_roll_min_retrace_eur", 0.02
                        ),
                        profit_roll_min_keep_profit_bps=getattr(
                            rcfg, "profit_roll_min_keep_profit_bps", 2.0
                        ),
